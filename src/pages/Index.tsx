...
import { Brain, Sparkles, Zap, BookOpen, Target, ArrowRight, Trophy, Flame, Star, X, Play, Clock, Users, ChevronRight, TrendingUp, Award, BarChart3, PieChart, Activity, GraduationCap, CheckCircle, AlertTriangle, UserCheck, Shield, FileText, Send, Bell, Settings, Database, Server, RefreshCcw } from "lucide-react";
...
interface AdminStats {
  ...
  systemUpdates: { id: number; type: string; message: string; time: string }[];
}
